        ...
        <>
            <div id='homeFilter' >
                ...
                <div className='mt-10 flex justify-between '>
                    <Link to="/fruits" className=' w-52 h-52 flex  justify-center items-center rounded-md '>
                    ...
                    <div className=' w-52 h-52 flex  justify-center items-center rounded-md '>
                    ...
                    <Link to="/vegetables" className=' w-52 h-52 flex  justify-center items-center rounded-md '>
                    ...
                    <div className=' w-52 h-52 flex  justify-center items-center rounded-md max-sm:hidden'>
                ...
                <div className='poster-1 mt-8 relative '>
                ...
                <div className='New-Ariivals mt-10'>
                ...
                <div className='poster-2 mt-20 grid grid-cols-2 gap-7 max-sm:grid-cols-1'>
                    ...
                    <div className='relative'>
                        <img src="images/posters/img12.jpg" alt="" className='w-[100%] h-[45vh] rounded-lg max-sm:h-[50vh]' />
                ...
                <div className='flex justify-between mt-10'>
                    <div className='text-center w-[20vw] mt-10 border border-[#e4e4e4] rounded-md py-5 cursor-pointer max-sm:w-[61vw] max-sm:py-8 max-sm:px-3 max-sm:space-y-5 max-sm:border-[#b9b9b9]'>
                ...
                <div className='grid grid-cols-4 mt-20 max-sm:grid-cols-2'>
                ...
                <div className="Latest-Blog mt-20">
