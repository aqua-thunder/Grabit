...
const Vegetables = ({ vegetables, detail, AddWishList }) => {
    const [vegetableCrousal, setVegetableCrousal] = useState([
        {
            url: "../images/posters/img2.jpg",
            title: "Buy fresh, eat fresh, stay fresh!",
            starting: "Starting at $ 29.9"
        },
        {
            url: "../images/posters/img13.jpg",
            title: "More veggies, more energy!",
            starting: "Starting at $ 29.9"
        }
    ])
    const notifyInsert = () => {
    ...
    return (
        <>
            <div className="crousal mt-5">
                <Slider {...settings}>
                    {
                        vegetableCrousal.map((items, index) => {
                            return (
            ...
            <div className='Vegetables mt-10'>
                <h1 className='text-[25px] font-bold text-[#4b5966] '>🌿 Healthy Living Starts <span className='text-[#5caf90]'>with Fresh Veggies! 🥒</span></h1>
                ...
                <div className='grid grid-cols-5 gap-7 max-sm:grid-cols-4'>
                    {
                        vegetables.map((productItem, productIndex) => {
                            return (
